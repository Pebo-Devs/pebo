...
private fun darkScheme(accent: Color, accent2: Color, base: Color): ColorScheme {
    ...
    return darkColorScheme(
        ...
        onSurface = l(0.94f),
        surfaceDim = l(0.025f),
        surfaceBright = l(0.12f),
        surfaceContainerLowest = l(0.015f),
        surfaceContainerLow = l(0.055f),
        surfaceContainer = l(0.10f),
        surfaceContainerHigh = l(0.14f),
        surfaceContainerHighest = l(0.18f),
        surfaceVariant = l(0.155f),
        onSurfaceVariant = l(0.62f),
        outline = l(0.28f),
        outlineVariant = l(0.155f),
        surfaceTint = accent,
    )
}
